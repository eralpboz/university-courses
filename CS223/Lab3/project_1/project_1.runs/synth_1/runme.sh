...
HD_PWD='C:/Vivaldo/Lab3/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log laundry_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source laundry_top.tcl
