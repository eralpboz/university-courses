...
REM
REM Generated by Vivado on Mon Apr 13 14:00:07 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_FSM_LndryMachine_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_FSM_LndryMachine_vlog.prj -log xvlog.log
