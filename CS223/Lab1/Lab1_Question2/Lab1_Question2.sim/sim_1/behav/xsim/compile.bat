...
REM
REM Generated by Vivado on Mon Mar 02 14:34:23 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_decoder_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_decoder_vlog.prj -log xvlog.log
