...
HD_PWD='C:/Vivaldo/Lab1/Lab1_Question4/Lab1_Question4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log logic_function.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source logic_function.tcl -notrace
