...
HD_PWD='C:/Vivaldo/Lab1/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log logicC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source logicC.tcl -notrace
