...
HD_PWD='C:/Vivaldo/Lab1/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log logicC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source logicC.tcl
