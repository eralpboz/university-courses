...
HD_PWD='C:/Vivaldo/Lab1/Lab1_Question1/Lab1_Question1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_16to1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_16to1.tcl
