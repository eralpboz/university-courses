...
HD_PWD='C:/Vivaldo/Lab1/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux161.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux161.tcl -notrace
