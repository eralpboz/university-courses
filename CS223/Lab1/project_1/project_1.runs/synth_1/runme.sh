...
HD_PWD='C:/Vivaldo/Lab1/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux161.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux161.tcl
