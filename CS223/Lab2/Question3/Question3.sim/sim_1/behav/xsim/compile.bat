...
REM
REM Generated by Vivado on Mon Mar 30 02:55:54 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_lab_counter_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_lab_counter_vlog.prj -log xvlog.log
