...
REM
REM Generated by Vivado on Mon Mar 30 14:52:54 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_multi_digit_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_multi_digit_vlog.prj -log xvlog.log
