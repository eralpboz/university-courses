...
HD_PWD='C:/Vivaldo/Lab2/Question3/Question3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab_counter.tcl
