...
HD_PWD='C:/Vivaldo/Lab2/Question3/Question3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab_counter.tcl -notrace
