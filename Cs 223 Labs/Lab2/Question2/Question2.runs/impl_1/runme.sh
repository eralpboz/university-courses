...
HD_PWD='C:/Vivaldo/Lab2/Question2/Question2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_digit_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multi_digit_display.tcl -notrace
