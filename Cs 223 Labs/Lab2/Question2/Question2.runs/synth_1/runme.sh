...
HD_PWD='C:/Vivaldo/Lab2/Question2/Question2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_digit_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multi_digit_display.tcl
