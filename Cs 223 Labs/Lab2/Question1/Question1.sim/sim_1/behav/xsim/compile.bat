...
REM
REM Generated by Vivado on Mon Mar 30 14:49:08 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj testbenchForRegister_vlog.prj"
call xvlog  --incr --relax -L uvm -prj testbenchForRegister_vlog.prj -log xvlog.log
