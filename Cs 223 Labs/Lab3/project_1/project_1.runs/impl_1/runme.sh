...
HD_PWD='C:/Vivaldo/Lab3/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log laundry_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source laundry_top.tcl -notrace
