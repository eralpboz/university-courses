...
HD_PWD='C:/Vivaldo/Lab1/Lab1_Question4/Lab1_Question4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log logic_function.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source logic_function.tcl
