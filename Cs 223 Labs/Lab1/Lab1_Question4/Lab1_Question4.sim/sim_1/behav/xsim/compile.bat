...
REM
REM Generated by Vivado on Mon Mar 02 14:38:44 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_logic_function_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_logic_function_vlog.prj -log xvlog.log
