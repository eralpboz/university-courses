...
REM
REM Generated by Vivado on Mon Mar 02 14:36:13 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_adder_subtractor_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_adder_subtractor_vlog.prj -log xvlog.log
