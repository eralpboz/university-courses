...
HD_PWD='C:/Vivaldo/Lab1/Lab1_Question3/Lab1_Question3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_subtractor_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder_subtractor_4bit.tcl -notrace
