...
HD_PWD='C:/Vivaldo/Lab1/Lab1_Question3/Lab1_Question3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_subtractor_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_subtractor_4bit.tcl
