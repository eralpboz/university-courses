...
HD_PWD='C:/Vivaldo/Lab1/Lab1_Question1/Lab1_Question1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_16to1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux_16to1.tcl -notrace
